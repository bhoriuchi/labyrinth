	...
	parameterversion: [
	    {
	    	...
	    	fk_activity_parameters_id: 'activityversion-log0'
	    },
	    {
	    	id: 2,
	    	parent_id: 1,
	    	...
	    	defaultValue: '',
	    	description: 'Message to print to the console',
	    	fk_activity_parameters_id: 'activityversion-log1'
	    }
	],
	activity: [
	    {
	...
	stepversion: [
	    {
	    	...
	    	fail: 3,
	    	exception: 3,
	    	fk_activity_activity_id: 'activityversion-start0',
	    	fk_workflow_steps_id: 'workflowversion-log0'
	    },
	    {
	    	id: 2,
	    	parent_id: 1,
	    	...
	    	fail: 3,
	    	exception: 3,
	    	fk_activity_activity_id: 'activityversion-start1',
	    	fk_workflow_steps_id: 'workflowversion-log1'
	    },
	    {
	    	id: 3,
	    	parent_id: 2,
	    	...
	    	fail: 3,
	    	exception: 3,
	    	fk_activity_activity_id: 'activityversion-log0',
	    	fk_workflow_steps_id: 'workflowversion-log0'
	    },
	    {
	    	id: 4,
	    	...
	    	fail: 3,
	    	exception: 3,
	    	fk_activity_activity_id: 'activityversion-log1',
	    	fk_workflow_steps_id: 'workflowversion-log1'
	    },
	    {
	    	id: 5,
	    	...
	    	fail: 3,
	    	exception: 3,
	    	fk_activity_activity_id: 'activityversion-end0',
	    	fk_workflow_steps_id: 'workflowversion-log0'
	    },
	    {
	    	id: 6,
	    	...
	    	fail: 3,
	    	exception: 3,
	    	fk_activity_activity_id: 'activityversion-end1',
	    	fk_workflow_steps_id: 'workflowversion-log1'
	    }
	]
};