...
module.exports = {
	wf_datatype: [
	    ...
	    },
	    {
	    	...
	    	source: 'var strValue = String(value).toLowerCase();strValue = ((!isNaN(strValue) && strValue !== \'0\') && strValue !== \'\' && strValue !== \'null\' && strValue !== \'undefined\') ? \'1\' : strValue; return strValue === \'true\' || strValue === \'1\' ? true : false;'
	    },
	    {
	    	id: 'datatype-object',
	    	name: 'object',
	...
	wf_parameterver: [
	    ...
	    },
	    {
	    	...
	    	fk_wf_datatype_dataType_id: 'datatype-boolean',
	    	//fk_wf_activityver_parameters_id: 'activityver-log0',
	    	fk_wf_workflowver_parameters_id: 'workflowver-log0'
	    },
	    {
