...
module.exports = function (env) {
	...
	return function(opts) {
		...
		return function(args) {
			...
			var requested = _.pluck(activity.modules, 'name');
			...
			// look for input
			_.forEach(activity.parameters, function(param) {
			...
			if (activity.source) {
				env.sbx.vm(activity.source, modules, variables, emitNext, step.timeout);
			}
			else {
				emitNext({});
			}
